                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="/single" title="">We are guests of ABC Design Studio</a></h4>
                                            <small>Trends</a></small>
                                            <small>21 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="/single" title="">Nostalgia at work with family</a></h4>
                                            <small><a >News</a></small>
                                            <small><a >20 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                            </div><!-- end row -->
